...
import image1 from "../../assets/protap.png"
import './Banner.css'
...
const Banner = () => {
   ...
   return (
      <div className='bg-[#212529] text-[#798792] py-16'>
         <Container>
            <div className='flex items-center justify-center'>
               <div className='w-3/4'>
                  ...
                  <button className='btn border-none text-[16px] text-white capitalize border-2 rounded-full px-8 mt-8 ms-5 bg-[#20C997] hover:bg-[#1BAA80]'>Download CV</button>
               </div>
