      ...
      <div className='bg-[#212529] pt-10 pb-16'>
         <Container>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 pt-5'>
               ...
               <div className='skill-card' data-aos="fade-right" data-aos-duration="1500">
                  <div className='pl-3'>
               ...
               <div className='skill-card' data-aos="zoom-in-down" data-aos-duration="1500">
                  <div className='pl-3'>
               ...
               <div className='skill-card' data-aos="flip-left" data-aos-duration="1500">
                  <div className='pl-3'>
               ...
               <div className='skill-card' data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="1500">
                  <div className='pl-3'>
               ...
               <div className='skill-card' data-aos="fade-up-right" data-aos-duration="1500">
                  <div className='pl-3'>
               ...
               <div className='skill-card' data-aos="flip-right" data-aos-duration="1500">
                  <div className='pl-3'>
