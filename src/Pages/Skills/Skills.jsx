      ...
      <Container>
        ...
        <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-7 gap-5 pt-5'>
          ...
          <div className='skill-card p-3' data-aos="fade-right" data-aos-duration="1500">
            <div>
              <img src={image1} alt="HTML" loading="lazy" className='w-16 mx-auto mb-2' />
          ...
          <div className='skill-card p-3' data-aos="fade-up" data-aos-duration="1500">
            <div>
              <img src={image2} alt="Bootstrap" loading="lazy" className='w-16 mx-auto mb-3' />
          ...
          <div className='skill-card p-3' data-aos="flip-left" data-aos-duration="1500">
            <div>
              <img src={image3} alt="Express" loading="lazy" className='w-16 mx-auto mb-2' />
          ...
          <div className='skill-card p-3' data-aos="zoom-in" data-aos-duration="1500">
            <div>
              <img src={image4} alt="Firebase" loading="lazy" className='w-16 mx-auto mb-2' />
          ...
          <div className='skill-card p-3' data-aos="fade-down" data-aos-duration="1500">
            <div>
              <img src={image5} alt="CSS3" loading="lazy" className='w-16 mx-auto mb-2' />
          ...
          <div className='skill-card p-3' data-aos="fade-up-right" data-aos-duration="1500">
            <div>
              <img src={image6} alt="Node" loading="lazy" className='w-14 mx-auto mb-2' />
          ...
          <div className='skill-card p-3' data-aos="zoom-in-up" data-aos-duration="1500">
            <div>
              <img src={image7} alt="MongoDB" loading="lazy" className='w-16 mx-auto mb-2' />
          ...
          <div className='skill-card p-3' data-aos="fade-right" data-aos-duration="1500">
            <div>
              <img src={image8} alt="React" loading="lazy" className='w-14 mx-auto mb-2' />
          ...
          <div className='skill-card p-3' data-aos="fade-up" data-aos-duration="1500">
            <div>
              <img src={image10} alt="Git" loading="lazy" className='w-14 mx-auto mb-2' />
          ...
          <div className='skill-card p-3' data-aos="zoom-out" data-aos-duration="1500">
            <div>
              <img src={image9} alt="Tailwind" loading="lazy" className='w-20 mx-auto mb-2' />
          ...
          <div className='skill-card p-3' data-aos="flip-right" data-aos-duration="1500">
            <div>
              <img src={image11} alt="JavaScript" loading="lazy" className='w-14 mx-auto mb-2' />
          ...
          <div className='skill-card p-3' data-aos="fade-down" data-aos-duration="1500">
            <div>
              <img src={image12} alt="Canva" loading="lazy" className='w-14 mx-auto mb-2' />
          ...
          <div className='skill-card p-3' data-aos="zoom-in" data-aos-duration="1500">
            <div>
              <img src={image13} alt="Figma" loading="lazy" className='w-14 mx-auto mb-2' />
          ...
          <div className='skill-card p-3' data-aos="fade-up" data-aos-duration="1500">
            <div>
              <img src={image14} alt="GitHub" loading="lazy" className='w-16 mx-auto mb-2' />
          ...
          <div className='skill-card p-3' data-aos="zoom-out-left" data-aos-duration="1500">
            <div>
              <img src={image15} alt="Vscode" loading="lazy" className='w-16 mx-auto mb-2' />
          ...
          <div className='skill-card p-3' data-aos="flip-up" data-aos-duration="1500">
            <div>
              <img src={image16} alt="Next" loading="lazy" className='mx-auto' />
          ...
          <div className='skill-card p-3' data-aos="zoom-in-up" data-aos-duration="1500">
            <div>
              <img src={image17} alt="Jest" loading="lazy" className='w-14 mx-auto mb-2' />
