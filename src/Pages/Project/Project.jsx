      ...
      <Container>
        ...
        <div className="project-card pt-5">
          ...
          <div className="card bg-[#444b52] shadow-md rounded-md mx-auto" data-aos="zoom-in" data-aos-duration="1500">
            <figure className="meet meet-planr h-96"></figure>

            <div className="card-body">
              <h2 className="card-title text-2xl text-white font-[Poppins]">MeetPlanr</h2>
              <p className="text-[#acbac5]">MeetPlanr is an event scheduling platform and it is a team project. Here user can create any type of meeting according to their time. Besides, users can update and delete events by purchasing the Premium service. Users can report if any function is not working on the website.</p>
